...
#' \emph{"peakInFeature"}, peak with highest significance is selected. Finally, whenever
#' annotated, for each gene, one best TSS and TES region peak is reported. \emph{"intergenic"}
#' peaks are not reported here as they are not annotated with gene information. \cr
